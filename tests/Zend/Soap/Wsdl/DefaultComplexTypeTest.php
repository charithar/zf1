...
class Zend_Soap_Wsdl_DefaultComplexTypeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testOnlyPublicPropertiesAreDiscoveredByStrategy()
    {
        ...
        $xml = $this->wsdl->toXML();
        $this->assertStringNotContainsStringIgnoringCase( Zend_Soap_Wsdl_DefaultComplexTypeTest_PublicPrivateProtected::PROTECTED_VAR_NAME, $xml);
        $this->assertStringNotContainsStringIgnoringCase( Zend_Soap_Wsdl_DefaultComplexTypeTest_PublicPrivateProtected::PRIVATE_VAR_NAME, $xml);
    }
}
