...
class Zend_Dojo_View_Helper_CheckBoxTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite("Zend_Dojo_View_Helper_CheckBoxTest");
        $suite->run();
    }
    ...
    public function testShouldCreateHiddenElementWithUncheckedValue()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('value="bar"', $m[1]);
    }
    ...
    public function testShouldCheckElementWhenValueMatchesCheckedValue()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('checked="checked"', $m[1]);
    }
    ...
    public function testElementShouldUseCheckedValueForCheckboxInput()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('value="1"', $matches[1]);
        $this->assertStringNotContainsStringIgnoringCase('checked', $matches[1]);
    }
    ...
    public function testElementShouldCreateAppropriateIdWhenNameIncludesArrayNotation()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('id="foo-bar"', $html);
    }
}
