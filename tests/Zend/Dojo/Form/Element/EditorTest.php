...
class Zend_Dojo_Form_Element_EditorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testShouldRenderEditorDijit()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('dojoType="dijit.Editor"', $html, $html);
    }
    ...
    public function testCaptureEventAccessorsShouldProxyToDijitParams()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('bar.baz', $events, var_export($events, 1));
    }
    ...
    public function testEventAccessorsShouldProxyToDijitParams()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('onKeyUp', $events, var_export($events, 1));
    }
    ...
    public function testPluginAccessorsShouldProxyToDijitParams()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('bold', $plugins, var_export($plugins, 1));
    }
    ...
    public function testStyleSheetAccessorsShouldProxyToDijitParams()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('/js/custom/styles.css', $styleSheets, var_export($styleSheets, 1));
    }
    ...
    public function testExtraPluginAccessorsShouldProxyToDijitParams()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('bold', $extraPlugins, var_export($extraPlugins, 1));
    }
}
