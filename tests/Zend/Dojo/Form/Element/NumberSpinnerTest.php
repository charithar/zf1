...
class Zend_Dojo_Form_Element_NumberSpinnerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite("Zend_Dojo_Form_Element_NumberSpinnerTest");
        $suite->run();
    }
    ...
    public function testShouldRenderNumberSpinnerDijit()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('dojoType="dijit.form.NumberSpinner"', $html);
    }
