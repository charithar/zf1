...
class Zend_Dojo_Form_Element_VerticalSliderTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite("Zend_Dojo_Form_Element_VerticalSliderTest");
        $suite->run();
    }
    ...
    public function testShouldRenderVerticalSliderDijit()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('dojoType="dijit.form.VerticalSlider"', $html);
    }
}
