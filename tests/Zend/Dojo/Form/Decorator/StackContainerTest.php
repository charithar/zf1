...
class Zend_Dojo_Form_Decorator_StackContainerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite("Zend_Dojo_Form_Decorator_StackContainerTest");
        $suite->run();
    }
    ...
    {
        $html = $this->decorator->render('');
        $this->assertStringContainsStringIgnoringCase('dojoType="dijit.layout.StackContainer"', $html);
    }
}
