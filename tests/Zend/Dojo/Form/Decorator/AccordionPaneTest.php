...
class Zend_Dojo_Form_Decorator_AccordionPaneTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite("Zend_Dojo_Form_Decorator_AccordionPaneTest");
        $suite->run();
    }
    ...
    {
        $html = $this->decorator->render('');
        $this->assertStringContainsStringIgnoringCase('dojoType="dijit.layout.AccordionPane"', $html);
    }
}
