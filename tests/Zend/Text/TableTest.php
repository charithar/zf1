...
class Zend_Text_TableTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testColumnSetContentInvalidArgument()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('$content must be a string', $expected->getMessage());
        }
    }
    ...
    public function testColumnSetAlignInvalidArgument()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Invalid align supplied', $expected->getMessage());
        }
    }
    ...
    public function testColumnSetColSpanInvalidArgument()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('$colSpan must be an integer and greater than 0', $expected->getMessage());
        }
    }
    ...
    public function testColumnRenderInvalidArgument()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('$columnWidth must be an integer and greater than 0', $expected->getMessage());
        }
    }
    ...
    public function testRowNotEnoughColumnWidths()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Too many columns', $expected->getMessage());
        }
    }
    ...
    public function testRowGetColumnWidthsBeforeRendering()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('No columns were rendered yet', $expected->getMessage());
        }
    }
    ...
    public function testTableConstructInvalidColumnWidths()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('You must supply at least one column', $expected->getMessage());
        }
    }
    ...
    public function testTableConstructInvalidColumnWidthsItem()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Column 0 has an invalid column width', $expected->getMessage());
        }
    }
    ...
    public function testTableWithoutRows()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('No rows were added to the table yet', $expected->getMessage());
        }
    }
