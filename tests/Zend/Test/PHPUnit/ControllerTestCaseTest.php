...
class Zend_Test_PHPUnit_ControllerTestCaseTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testOverloadingShouldPreventSettingRequestResponseAndFrontControllerObjects()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('not allow', $e->getMessage());
        }
    ...
    public function testDispatchShouldDispatchSpecifiedUrl()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('FooController::barAction', $content, $content);
    }
    ...
    public function testResetResponseShouldClearAllViewPlaceholders()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('Foo', $view->headTitle()->__toString(), 'Head title persisted?');
    }
