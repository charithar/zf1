...
class Zend_Db_Profiler_StaticTest extends Zend_Db_TestSetup
{
    ...
    public function testProfilerFactoryInvalidClass()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Profiler argument must be an instance of', $e->getMessage());
        }
    }
    ...
    public function testProfilerQueryEndHandleInvalid()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('no query with handle', $e->getMessage());
        }
    }
    ...
    public function testProfilerQueryEndAlreadyEnded()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('has already ended', $e->getMessage());
        }
    }
