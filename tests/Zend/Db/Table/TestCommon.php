...
abstract class Zend_Db_Table_TestCommon extends Zend_Db_Table_TestSetup
{
    ...
    public function testTableImplicitName()
    {
        ...
        $info = $table->info();
        $this->assertStringContainsStringIgnoringCase('name', array_keys($info));
    ...
    public function testTableOptionSchema()
    {
        ...
        $info = $table->info();
        $this->assertStringContainsStringIgnoringCase('schema', array_keys($info));
    ...
    public function testTableExceptionPrimaryKeyNotSpecified()
    {
        try {
            ...
            $this->assertTrue($e instanceof Zend_Db_Table_Exception,
                'Expecting object of type Zend_Db_Table_Exception, got '.get_class($e));
            $this->assertStringContainsStringIgnoringCase("Primary key column(s)", $e->getMessage());
            $this->assertStringContainsStringIgnoringCase("are not columns in this table", $e->getMessage());
        }
    }
    ...
    public function testTableInsertWithSchema()
    {
        ...
        $this->assertStringContainsStringIgnoringCase("INSERT INTO $tableSpec ", $qp->getQuery());
    }
    ...
    public function testTableUpdateWithSchema()
    {
        ...
        $qp = $this->_db->getProfiler()->getLastQueryProfile();
        $tableSpec = $this->_db->quoteIdentifier($identifier, true);
        $this->assertStringContainsStringIgnoringCase("UPDATE $tableSpec ", $qp->getQuery());
    }
    ...
    public function testTableDeleteWithSchema()
    {
        ...
        $qp = $this->_db->getProfiler()->getLastQueryProfile();
        $tableSpec = $this->_db->quoteIdentifier($identifier, true);
        $this->assertStringContainsStringIgnoringCase("DELETE FROM $tableSpec ", $qp->getQuery());
    }
