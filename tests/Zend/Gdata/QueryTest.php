...
class Zend_Gdata_QueryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSetAndGetAlt()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('alt=rss', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetUpdatedMax()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('updated-max=2007-01-01', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetUpdatedMin()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('updated-min=2007-01-01', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetPublishedMax()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('published-max=2007-01-01',
            $query->getQueryUrl());
    }
    ...
    public function testSetAndGetPublishedMin()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('published-min=2007-01-01',
                $query->getQueryUrl());
    }
    ...
    public function testSetAndGetAuthor()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('author=My+Name', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetMaxResults()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('max-results=300', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetGenericParam()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('fw=zend', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetFullTextQuery()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('q=geek+events', $query->getQueryUrl());
    }
    ...
    public function testSetAndGetStartIndex()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('start-index=12', $query->getQueryUrl());
    }
