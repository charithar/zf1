...
class Zend_Form_Decorator_ViewScriptTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRenderRaisesExceptionIfNoViewScriptRegistered()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('script', $e->getMessage());
        }
    }
    ...
    public function testRenderingRendersViewScript()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('This is content from the view script', $test);
    }
    ...
    public function testOptionsArePassedToPartialAsVariables()
    {
        ...
        foreach ($this->decorator->getOptions() as $key => $value) {
            $this->assertStringContainsStringIgnoringCase("$key: $value", $test);
        }
    }
    ...
    public function testCanReplaceContentBySpecifyingFalsePlacement()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('content to decorate', $test, $test);
        $this->assertStringContainsStringIgnoringCase('This is content from the view script', $test);
    }
    ...
    public function testContentCanBeRenderedWithinViewScript()
    {
        ...
        $test = $this->decorator->render('content to decorate');
        $this->assertStringContainsStringIgnoringCase('content to decorate', $test, $test);
        $this->assertStringContainsStringIgnoringCase('This text prefixes the content', $test);
        $this->assertStringContainsStringIgnoringCase('This text appends the content', $test);
    }
