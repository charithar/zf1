...
class Zend_Translate_Adapter_TmxTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite("Zend_Translate_Adapter_TmxTest");
        $suite->run();
    }
    ...
    public function testCreate()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('is not readable', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Mismatched tag at line', $e->getMessage());
        }
    }
    ...
    public function testErrorOnCreateIncludesFilename()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('nofile.tmx', $e->getMessage());
        }
    }
