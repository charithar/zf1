...
class Zend_Validate_File_FilesSizeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testFailureMessage()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('1.55kB', current($validator->getMessages()));
        ...
        $this->assertStringContainsStringIgnoringCase('1588', current($validator->getMessages()));
    }
