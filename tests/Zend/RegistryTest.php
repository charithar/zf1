...
class Zend_RegistryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRegistryUninitGet()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('No entry is registered for key', $e->getMessage());
        }
        $registry = Zend_Registry::getInstance();
        $this->assertTrue($registry instanceof Zend_Registry);
    }
    ...
    public function testRegistryExceptionInvalidClassname()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Argument is not a class name', $e->getMessage());
        }
    }
    ...
    public function testRegistryExceptionAlreadyInitialized()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Registry is already initialized', $e->getMessage());
        }
        try {
