...
EOT;
        ...
        // Test for one of the expected fields in the JSON result.
        $this->assertStringContainsStringIgnoringCase("Homestyle Breakfast", $phpArray['breakfast_menu']['food'][4], "The last breakfast item name converted from XML input 3 is not correct");
...
EOT;
        ...
        // Test for one of the expected fields in the JSON result.
        $this->assertStringContainsStringIgnoringCase("98-765-4321", $phpArray['PurchaseRequisition']['Item']['Vendor'], "The vendor id converted from XML input 4 is not correct");
        // Test for the presence of multiple XML attributes present that were carried over in the JSON result.
        $this->assertStringContainsStringIgnoringCase("UNSPSC", $phpArray['PurchaseRequisition']['Item']['Specification']['Category']['@attributes'], "The type attribute converted from XML input 4 is not correct");
        $this->assertStringContainsStringIgnoringCase("32121501", $phpArray['PurchaseRequisition']['Item']['Specification']['Category']['@attributes'], "The value attribute converted from XML input 4 is not correct");
        $this->assertStringContainsStringIgnoringCase("Fixed capacitors", $phpArray['PurchaseRequisition']['Item']['Specification']['Category']['@attributes'], "The name attribute converted from XML input 4 is not correct");
...
EOT;
        ...
        $this->assertStringContainsStringIgnoringCase("Lois & Clark", $phpArray['tvshows']['show'][1]['name'], "The CDATA name converted from XML input 5 is not correct");
...
EOT;
        ...
        // Test for one of the expected fields in the JSON result.
        $this->assertStringContainsStringIgnoringCase("Zend", $phpArray['demo']['framework']['name'], "The framework name field converted from XML input 6 is not correct");
        // Test for one of the expected CDATA fields in the JSON result.
        $this->assertStringContainsStringIgnoringCase('echo getMovies()->asXML();', $phpArray['demo']['listing']['code'], "The CDATA code converted from XML input 6 is not correct");
