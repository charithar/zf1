    ...
    extends Zend_Cloud_DocumentService_TestCase
{
    ...
    public function testUpdateDocumentMergeAll()
    {
        ...
        $this->assertStringContainsStringIgnoringCase($doc->name, $fetchdoc->name, "Name field did not update: " . var_export($fetchdoc->getFields(), 1));
        $this->assertStringContainsStringIgnoringCase($doc1->name, $fetchdoc->name, "Name field did not update: " . var_export($fetchdoc->getFields(), 1));
        $this->assertStringContainsStringIgnoringCase((string) $doc->year, $fetchdoc->year, "Year field did not update: " . var_export($fetchdoc->getFields(), 1));
        $this->assertStringContainsStringIgnoringCase((string) $doc1->year, $fetchdoc->year, "Year field did not update: " . var_export($fetchdoc->getFields(), 1));
    ...
    public function testUpdateDocumentMergeSome()
    {
        ...
        $this->assertStringContainsStringIgnoringCase((string) $doc1->pages, $fetchdoc->pages, "Page field did not update");
        $this->assertStringContainsStringIgnoringCase((string) $doc->pages, $fetchdoc->pages, "Page field did not update");
        $this->assertStringContainsStringIgnoringCase((string) $doc1->year, $fetchdoc->year, "Year field did not update");
        $this->assertStringContainsStringIgnoringCase((string) $doc->year, $fetchdoc->year, "Year field did not update");
