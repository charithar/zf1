...
class Zend_Service_Yahoo_OfflineTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testResultSetCurrentException()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('implemented by child', $e->getMessage());
        }
    }
    ...
    public function testInlinkDataSearchExceptionResultsInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'results'", $e->getMessage());
        }
    }
    ...
    public function testInlinkDataSearchExceptionStartInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'start'", $e->getMessage());
        }
    }
    ...
    public function testInlinkDataSearchExceptionOmitLinksInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'omit_inlinks'", $e->getMessage());
        }
    }
    ...
    public function testImageSearchExceptionTypeInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'type'", $e->getMessage());
        }
    }
    ...
    public function testImageSearchExceptionFormatInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'format'", $e->getMessage());
        }
    }
    ...
    public function testImageSearchExceptionColorationInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'coloration'", $e->getMessage());
        }
    }
    ...
    public function testLocalSearchExceptionLongitudeInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'longitude'", $e->getMessage());
        }
    }
    ...
    public function testLocalSearchExceptionLatitudeInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'latitude'", $e->getMessage());
        }
    }
    ...
    public function testLocalSearchExceptionZipInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'zip'", $e->getMessage());
        }
    }
    ...
    public function testLocalSearchExceptionLocationMissing()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Location data', $e->getMessage());
        }
    }
    ...
    public function testLocalSearchExceptionSortInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase("option 'sort'", $e->getMessage());
        }
    }
    ...
    public function testNewsSearchExceptionLanguageInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('selected language', $e->getMessage());
        }
    }
    ...
    public function testWebSearchExceptionOptionInvalid()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('parameters are invalid', $e->getMessage());
        }
    }
