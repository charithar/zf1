...
class Zend_Ldap_OriginalConnectTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testEmptyOptionsConnect()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('host parameter is required', $zle->getMessage());
        }
    }
    public function testUnknownHostConnect()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Can\'t contact LDAP server', $zle->getMessage());
        }
    }
