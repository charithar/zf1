...
class Zend_Ldap_CrudTest extends Zend_Ldap_OnlineTestCase
{
    ...
    public function testAddObjectClass()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('organizationalUnit', $entry['objectclass']);
            $this->assertStringContainsStringIgnoringCase('domainRelatedObject', $entry['objectclass']);
        } catch (Zend_Ldap_Exception $e) {
            if ($this->_getLdap()->exists($dn)) {
                $this->_getLdap()->delete($dn);
            }
    ...
    public function testRemoveObjectClass()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('organizationalUnit', $entry['objectclass']);
            $this->assertStringNotContainsStringIgnoringCase('domainRelatedObject', $entry['objectclass']);
        } catch (Zend_Ldap_Exception $e) {
            if ($this->_getLdap()->exists($dn)) {
                $this->_getLdap()->delete($dn);
            }
