...
class Zend_Navigation_PageTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSetAndGetLabel()
    {
        ...
        foreach ($invalids as $invalid) {
            try {
                ...
                $this->assertStringContainsStringIgnoringCase('Invalid argument: $label', $e->getMessage());
            }
        }
    }
    ...
    public function testSetAndGetId()
    {
        ...
        foreach ($invalids as $invalid) {
            try {
                ...
                $this->assertStringContainsStringIgnoringCase('Invalid argument: $id', $e->getMessage());
            }
        }
    }
    ...
    public function testSetAndGetClass()
    {
        ...
        foreach ($invalids as $invalid) {
            try {
                ...
                $this->assertStringContainsStringIgnoringCase('Invalid argument: $class', $e->getMessage());
            }
        }
    }
    ...
    public function testSetAndGetTitle()
    {
        ...
        foreach ($invalids as $invalid) {
            try {
                ...
                $this->assertStringContainsStringIgnoringCase('Invalid argument: $title', $e->getMessage());
            }
        }
    }
    ...
    public function testSetAndGetTarget()
    {
        ...
        foreach ($invalids as $invalid) {
            try {
                ...
                $this->assertStringContainsStringIgnoringCase('Invalid argument: $target', $e->getMessage());
            }
        }
    }
    ...
    public function testSetAndGetOrder()
    {
        ...
        foreach ($invalids as $invalid) {
            try {
                ...
                $this->assertStringContainsStringIgnoringCase('Invalid argument: $order', $e->getMessage());
            }
        }
    }
    ...
    public function testSetResourceShouldThrowExceptionWhenGivenInteger()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Invalid argument: $resource', $e->getMessage());
        }
    }
    ...
    public function testMagicOverLoadsShouldCheckNativeProperties()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Unsetting native property', $e->getMessage());
        }
    }
    ...
    public function testSetRelShouldThrowExceptionWhenNotNullOrArrayOrConfig()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Invalid argument: $relations', $e->getMessage());
        }
    }
