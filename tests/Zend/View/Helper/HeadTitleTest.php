...
class Zend_View_Helper_HeadTitleTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCanSetTitleViaHeadTitle()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('Foo Bar', $placeholder->toString());
    }
    ...
    public function testCanAppendTitleViaHeadTitle()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('FooBar', $placeholder->toString());
    }
    ...
    public function testCanPrependTitleViaHeadTitle()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('BarFoo', $placeholder->toString());
    }
    ...
    public function testToStringEscapesEntries()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('<script', $string);
        $this->assertStringNotContainsStringIgnoringCase('</script>', $string);
    }
    ...
    public function testToStringEscapesSeparator()
    {
        $this->helper->headTitle('Foo')
                     ...
                     ->setSeparator(' <br /> ');
        $string = $this->helper->toString();
        $this->assertStringNotContainsStringIgnoringCase('<br />', $string);
        $this->assertStringContainsStringIgnoringCase('Foo', $string);
        $this->assertStringContainsStringIgnoringCase('Bar', $string);
        $this->assertStringContainsStringIgnoringCase('br /', $string);
    }
    ...
    public function testIndentationIsHonored()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('    <title>', $string);
    }
