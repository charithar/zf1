...
class Zend_View_Helper_HeadLinkTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCreatingLinkStackViaHeadScriptCreatesAppropriateOutput()
    {
        ...
        foreach ($links as $link) {
            ...
            $this->assertStringContainsStringIgnoringCase($substr, $string);
            $substr = ' rel="' . $link['rel'] . '"';
            $this->assertStringContainsStringIgnoringCase($substr, $string);
    ...
    public function testConditionalStylesheetNotCreatedByDefault()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('<!--[if', $string);
        $this->assertStringNotContainsStringIgnoringCase(']>', $string);
        $this->assertStringNotContainsStringIgnoringCase('<![endif]-->', $string);
    }
    ...
    public function testConditionalStylesheetCreationOccursWhenRequested()
    {
        ...
        $string = $this->helper->toString();
        $this->assertStringContainsStringIgnoringCase('/styles.css', $string);
        $this->assertStringContainsStringIgnoringCase('<!--[if ie6]>', $string);
        $this->assertStringContainsStringIgnoringCase('<![endif]-->', $string);
    }
    ...
    public function testBooleanStylesheet()
    {
        ...
        $test = $this->helper->toString();
        $this->assertStringNotContainsStringIgnoringCase('[if false]', $test);
    }
    ...
    public function testBooleanTrueConditionalStylesheet()
    {
        ...
        $test = $this->helper->toString();
        $this->assertStringNotContainsStringIgnoringCase('[if 1]', $test);
        $this->assertStringNotContainsStringIgnoringCase('[if true]', $test);
    }
    ...
    public function testTurnOffAutoEscapeDoesNotEncodeAmpersand()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('id=123&foo=bar', $this->helper->toString());
    }
    ...
    public function testSetAlternateWithExtras()
    {
        ...
        $test = $this->helper->toString();
        $this->assertStringContainsStringIgnoringCase('media="print,screen"', $test);
    }
    ...
    public function testAppendStylesheetWithExtras()
    {
        ...
        $test = $this->helper->toString();
        $this->assertStringContainsStringIgnoringCase('id="my_link_tag"', $test);
    }
    ...
    public function testSetStylesheetWithMediaAsArray()
    {
        ...
        $test = $this->helper->toString();
        $this->assertStringContainsStringIgnoringCase(' media="screen,print"', $test);
    }
    ...
    public function testIdAttributeIsSupported()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('id="foo"', $this->helper->toString());
    }
    ...
    public function testHeadLinkAllowsOverrideOfRelAttribute()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('rel="stylesheet/less"', $this->helper->toString());
    }
    ...
    public function testConditionalStylesheetCreationNoIE()
    {
        ...
        $string = $this->helper->toString();
        $this->assertStringContainsStringIgnoringCase('/styles.css', $string);
        $this->assertStringContainsStringIgnoringCase('<!--[if !IE]><!--><', $string);
        $this->assertStringContainsStringIgnoringCase('<!--<![endif]-->', $string);
    }
