    ...
    extends Zend_View_Helper_Navigation_TestAbstract
{
    ...
    public function testSetRoleThrowsExceptionWhenGivenAnInt()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('$role must be a string', $e->getMessage());
        }
    }
    ...
    public function testSetDefaultRoleThrowsExceptionWhenGivenAnInt()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('$role must be', $e->getMessage());
        }
    }
    ...
    public function testMagicToStringShouldNotThrowException()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('array must contain two values', $this->_errorMessage);
    }
