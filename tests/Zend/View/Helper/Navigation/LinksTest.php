    ...
    extends Zend_View_Helper_Navigation_TestAbstract
{
    ...
    public function testFindRelationMustSpecifyRelOrRev()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Invalid argument: $rel', $e->getMessage());
        }
    }
    ...
    public function testRenderLinkMustSpecifyRelOrRev()
    {
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Invalid relation attribute', $e->getMessage());
        }
    }
