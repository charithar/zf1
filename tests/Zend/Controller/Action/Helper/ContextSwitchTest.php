...
class Zend_Controller_Action_Helper_ContextSwitchTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSetSuffixModifiesContextSuffix()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('foobar', $this->helper->getSuffix('xml'));
    }
    ...
    public function testSetSuffixPrependsToViewRendererSuffixByDefault()
    {
        ...
        $this->assertStringContainsStringIgnoringCase($expected, $this->helper->getSuffix('xml'));
    }
    ...
    public function testSuffixAccessorsThrowExceptionOnInvalidContextType()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Cannot set suffix', $e->getMessage());
        }
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Cannot retrieve suffix', $e->getMessage());
        }
    }
    ...
    public function testAddHeaderThrowsExceptionWhenReferencingExistingHeader()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('already exists', $e->getMessage());
        }
    }
    ...
    public function testCanAddContext()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('foo.bar', $context['suffix']);
    ...
    public function testAddContextThrowsExceptionIfContextAlreadyExists()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('exists', $e->getMessage());
        }
    }
    ...
    public function testCanOverwriteManyContextsAtOnce()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('foo.bar', $this->helper->getSuffix('foobar'));
        $this->assertNotEquals('bar.baz', $this->helper->getSuffix('barbaz'));
        $this->assertStringContainsStringIgnoringCase('bar.baz', $this->helper->getSuffix('barbaz'));
    }
    ...
    public function testSetDefaultContextThrowsExceptionIfContextDoesNotExist()
    {
        try {
            ...
            $this->assertStringContainsStringIgnoringCase('Cannot set default context', $e->getMessage());
        }
    }
    ...
    public function testInitContextUsesBooleanTrueActionValueToAssumeAllContexts()
    {
        ...
        $this->assertStringContainsStringIgnoringCase('json', $this->viewRenderer->getViewSuffix());

        $this->request->setParam('format', 'xml')
                      ->setActionName('all');
        $this->helper->initContext();
        $this->assertEquals('xml', $this->helper->getCurrentContext());
        $this->assertStringContainsStringIgnoringCase('xml', $this->viewRenderer->getViewSuffix());
    }
    ...
    public function testForwardingShouldNotUseContextSuffixIfNewActionDoesNotDetectValidContext()
    {
        ...
        $this->assertStringNotContainsStringIgnoringCase('xml', $suffix, $suffix);
    }
    ...
    public function testForwardingShouldNotPrependMultipleViewSuffixesForCustomContexts()
    {
        ...
        $suffix = $this->viewRenderer->getViewSuffix();
        $this->assertStringContainsStringIgnoringCase('foo', $suffix, $suffix);
        ...
        $suffix = $this->viewRenderer->getViewSuffix();
        $this->assertStringContainsStringIgnoringCase('foo', $suffix, $suffix);
        $this->assertStringNotContainsStringIgnoringCase('foo.foo', $suffix, $suffix);
    }
